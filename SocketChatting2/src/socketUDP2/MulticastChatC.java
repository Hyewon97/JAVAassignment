...
public class MulticastChatC extends Frame implements ActionListener, KeyListener {
	...
	public MulticastChatC() {
		super("client");
		mlbl = new Label("ask sign up in multicast chat server!");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == log_b) {
			if (ID == null) {
				...
				mlbl.setText("re login!!!");
			}

		} else if (ae.getSource() == logout) {
			mlbl = new Label("ask sign in on multicast chat server!");
